...
class MainWindow(QMainWindow):
    ...
    def _answers_panel(self) -> QWidget:
        ...
        hint = QLabel("Select a question to preview · click the question or answer to copy")
        hint.setObjectName("answersHint")
        layout.addWidget(hint)

        questions_label = QLabel("QUESTIONS")
        questions_label.setObjectName("answersSectionLabel")
        ...
        self.answer_titles_list.setMaximumHeight(128)
        ...
        answer_label.setObjectName("answersSectionLabel")
